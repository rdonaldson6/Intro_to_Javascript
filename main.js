...
//================================================
// 4a
console.log("Hello, My name is Ryan Donaldson");
// 4b
...
//6e
console.log("The answer is: $"+ (33-15.87));
...
//8f
console.log("The final total is : "+total+",when the starting values are \'foo\': "+foo+" and \'bar\': "+ bar)